...
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>Credit Suisse</strong></li>
    ...
    <br></br>
    <li className = "item-bullet">Placed on business analytics team; will be working on trade and settlement flow</li>
    <li className = "item-bullet"><strong>Coursework: </strong>Discrete Math, Data Structures and Algorithms, Data Mining, Formal Systems, Computational Statistics</li>
    </ul>
    </div>
  </div>
  <div className = "kobe">
