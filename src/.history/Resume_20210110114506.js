...
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>University of Rochester</strong></li>
    ...
    <li className = "item"><strong>Activities: </strong>Men's Varsity Golf, Varsity Student Athletes Advisory Committee, After Hours A Cappella, Google Developer Students Club</li>
    </ul>
    </div>
...
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>University of Rochester Medical Center</strong></li>
  ...
  <div className = "info">
    <ul className = "card">
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>Languages</strong></li>
    <li className = "item">Java, Python, JavaScript, CSS, HTML</li>
    <li className = "item" style = {{fontSize: 17 + 'px'}}><strong>Frameworks</strong></li>
    </ul>
    </div>
  </div>
