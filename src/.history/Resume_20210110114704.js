...
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>University of Rochester Medical Center</strong></li>
  ...
  <div className = "info">
    <ul className = "card">
    <li className = "item"><strong>Languages: </strong>Dean's List, Dean's Scholarship for Academic Achievement</li>
    <li className = "item"><strong>Frameworks: </strong>Discrete Math, Data Structures and Algorithms, Data Mining, Formal Systems, Computational Statistics</li>
    </ul>
    </div>
  </div>
