...
function Resume() {
  return (
    <div>
        <div className = "top"><h2 className = "header" style = {{lineSpacing: 0, fontSize: 20 + 'px'}}><strong>EDUCATION</strong><p style = {{lineSpacing: 0,textAlign: 'right', fontSize: 12 + 'px'}}>Download as PDF</p></h2></div>
