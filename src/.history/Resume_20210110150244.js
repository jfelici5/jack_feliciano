...
function Resume() {
  return (
    <div>
        ...
        <h2 className = "header" style = {{lineSpacing: 0, fontSize: 20 + 'px'}}><strong>EDUCATION</strong><p style = {{lineSpacing: 0,textAlign: 'right', fontSize: 12 + 'px'}}>Download as PDF</p></h2>
