  ...
  return (
    <div>
        <div className = 'nav-links'>
            <h2 className = 'words'> 
            <Link to = "/resume"><p className = "home">Home</p></Link>            </h2>
            <h2 className = 'words'> 
            ...
            <h2 className = 'words'> 
            <Link to = "/resume"><p className = "projects">Projects</p></Link>
            <p style = {{color: "blue"}}>2048</p>
            <p style = {{color: "blue"}}>urafterhours</p>
            </h2>
            <h2 className = 'words'> 
            <Link to = "/resume"><p className = "gallery">Gallery</p></Link>            <p className = "city"style = {{color: "blue"}}>Walnut Creek</p>
