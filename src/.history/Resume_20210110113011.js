...
function Resume() {
  return (
    <div>
        <h2 className = "header" style = {{fontSize: 17 + 'px'}}><strong>EDUCATION</strong></h2>
    <div className = "kobe">
    <div className = "info">
    <ul className = "card">
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>University of Rochester</strong></li>
  ...
  <h2 className = "header" style = {{fontSize: 17 + 'px'}}><strong>EXPERIENCE</strong></h2>
  <div className = "kobe">
  <div className = "info">
    <ul className = "card">
<li className = "item" style = {{fontSize: 17 + 'px'}}><strong>Credit Suisse</strong></li>
  ...
  <div className = "info">
    <ul className = "card">
<li className = "item" style = {{fontSize: 20 + 'px'}}><strong>University of Rochester Medical Center</strong></li>
