...
function Incline() {
  return (
    ...
    <>
    <h1 className = "heading"style = {{fontFamily: "Helvetica Neue", fontSize: 35 + 'px'}}>Lake Tahoe</h1>
    ...
    <br></br>
    <p className = "write-up">The waning hours of daylight...</p>
    <br></br>
    ...
    <p className = "write-up-right">...the difference that just a few minutes can make</p>
    <br></br>
