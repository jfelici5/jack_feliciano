...
function Incline() {
  return (
    ...
    <>
        ...
        seven years, and I was simply blown away. This picture above is taken at Incline Beach at the 
        </p>
    <div className = "holder"><div className = "gallery-content"><img src = {car}></img></div><div className = "gallery-content-1"><img src = {lighthouse}></img></div></div>
