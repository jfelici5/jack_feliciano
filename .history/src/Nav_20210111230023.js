...
function myFunction() {
  ...
  $nav2.toggleClass("dark-mode");
  $nav3.toggleClass("dark-mode");
  $nav4.toggleClass("dark-mode");
  $nav5.toggleClass("dark-mode");
  $nav6.toggleClass("dark-mode");
  $nav7.toggleClass("dark-mode");
}
}
