...
function Incline() {
  return (
    ...
    <>
        <h1 style = {{fontFamily: "HelveticaNeueforTargetUni-Bd", fontSize: 35 + 'px'}}>Lake Tahoe</h1>
    ...
    <div className = "holder"><div className = "gallery-content"><img src = {car}></img></div><div className = "gallery-content-1"><img src = {dock}></img><img src = {docker}></img></div></div>
    </>
    </DocumentTitle>
  );
}
