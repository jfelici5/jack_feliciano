  ...
  return (
    <div className = "kobe">
      ...
      <ul className = "card">
        ...
        <li className = "item">email - jfelici5@u.rochester.edu</li>
        <li className = "item">github - jfelici5</li>
        <li className = "item">linkedin - jack-feliciano</li>
        <li className = "item">vsco - jack-feliciano</li>
      </ul>
      </div>
